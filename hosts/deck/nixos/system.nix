...
in {
    ...
    services.udev.extraRules = ''
        ...
        ACTION=="add|change", SUBSYSTEM=="input", KERNEL=="event*", ATTRS{name}=="FTS3528:00 2808:1015", ENV{WL_OUTPUT}="${monitors.deck.name}"
        ACTION=="add|change", SUBSYSTEM=="input", KERNEL=="event*", ATTRS{name}=="FTS3528:00 2808:1015 UNKNOWN", ENV{WL_OUTPUT}="${monitors.deck.name}"

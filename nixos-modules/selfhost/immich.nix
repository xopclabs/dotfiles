...
in
{
    ...
    config = mkIf cfg.enable {
        services.immich = {
            ...
            # Use default "immich" user (required for database with vector extensions)
            # but set group to "users" for file access permissions
            group = "users";
        ...
        # Add immich user to users group for shared file access
